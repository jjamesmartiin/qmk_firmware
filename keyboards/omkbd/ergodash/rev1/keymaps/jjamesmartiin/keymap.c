...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
    ...
    MO(1),   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_LPRN ,                       KC_RPRN, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_SPC ,                        OSM(MOD_LSFT),    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
    KC_LCTL, KC_LGUI, KC_LALT, OSM(MOD_LSFT),   KC_SPC,   KC_LCTL, MO(2),         KC_ENT,KC_BSPC , KC_SPC,            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
  ),
